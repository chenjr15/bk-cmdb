...
func runGrpcServer(ctx context.Context, opts *RunOptions, g *run.Group, tlsConf *tls.Config, tlsEnabled bool) error {
	...
	grpcOpts := []grpc.ServerOption{
		grpc.UnaryInterceptor(middleware.ConvGrpcUnaryInterceptor(opts.Metrics.GrpcUnaryServerInterceptor)),
		grpc.StreamInterceptor(middleware.ConvGrpcStreamInterceptor(opts.Metrics.GrpcStreamServerInterceptor)),

...
// GrpcCtx creates a new grpc request context with kit metadata.
func (kt *Kit) GrpcCtx() context.Context {
	return metadata.NewOutgoingContext(kt.Context, metadata.Pairs(
		UserHeader, kt.User,
		AppCodeHeader, kt.AppCode,
		TenantHeader, kt.TenantID,
		i18n.BKHTTPLanguage, string(kt.Language),
	))
}
